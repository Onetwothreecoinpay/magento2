...
define(
    [
        ...
        'mage/url',
        'Onetwothreecoinpays_Onetwothreecoinpays/js/action/set-payment-method',
    ...
    function (ko,
        ...
        return Component.extend({
            defaults: {
                template: 'Onetwothreecoinpays_Onetwothreecoinpays/payment/coin_payment'
            },
            /**
             * @returns {string}
             */
            ...
            placeOrder: function (data, event) {
                console.log('ngo cam ha log placeOrder');
                if (event) {
