...
namespace Onetwothreecoinpays\Onetwothreecoinpays\Controller\Iframe;
...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $html           = 'You will be transfered to <a href="'.$coinpaymentUrl.'" target="_blank\">123coinpay.com</a> to complete your purchase when using this payment method..';
