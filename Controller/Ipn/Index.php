...
use Onetwothreecoinpays\Onetwothreecoinpays\Helper\Data as CoinPaymentHelper;
    ...
    private function checkStatus($status, $order)
    {
        if ($status < 0) {
            ...
            $order->setState(
                ...
                true,
                '123coinpay.com Payment Status: ' . $this->getRequest()->getParam(
                    'status_text'
                )
            ...
            if ($status >= 100 || $status == 2) {
                ...
                $str = '123coinpay.com Payment Status: ' . $this->getRequest()->geпtParam('status_text')
                    . '<br />';
                ...
                //order pending
                $str = '123coinpay.com Payment Status: ' . $this->getRequest()->getParam('status_text');
